...
generated: { by: "claude-code:claude-opus-5-5", at: "2026-09-24T03:46:01Z" }
status: stable
...
1. `29-start-monday`: the six-rung adoption ladder. The only place the six framework parts are listed as steps. Since 2026-09-23, the Harness Augmentation Framework graphic from `08-haf` sits beside the ladder at the owner's request, as a callback. Its legend names the six parts, but as a figure and not as steps, so it does not break the list-once invariant.
