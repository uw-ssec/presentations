...
description: "The models-matter chart lists MAI Code 1.1 Flash (Microsoft AI), which an earlier draft misnamed MyCode; the label is a bare model name like the other bars, with no vendor suffix, and the same name appears in the NOTES.md row."
...
- Bars use bare model names (Sonnet 5, Haiku, Kimi K3, GPT Terra, GPT Luna, MAI Code 1.1 Flash, Qwen 3.8 local 4-bit). Do not add vendor names in parentheses; the row fits at 1280x720 as is.
